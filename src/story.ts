...
export const NODES: NodeDef[] = [
  {
    ...
    pages: [
      { speaker: '母亲（消息）', text: '水给你灌满了，别在外头找水喝。手套戴上。' },
      { text: '出发口比昨天多了一名护运队员，姓程，四十来岁。他挨个确认随行人员，检查口罩和手套。母亲补过指尖的线手套，已在许晨口袋里。' },
      { speaker: '老程', text: '核对任务：旧物流园，找包装材料——几吨空罐和封口膜，送去食品厂复产。不是去找吃的，更不是去翻私人物资。' },
      { text: '魏姐说过，参与的人计入临时保供名单，有一份额外口粮。他不用装卸，只要认库位、查标签。' },
      { text: '“工具分开拿，别放脚边。”一根撬棍横进许晨怀里。黑漆掉了不少，弯头上粘着木屑。借用，编号登记，回来要还。' },
      { speaker: '杜平', text: '都齐了就上车。今天沿途多停停——魏姐交代过。' },
      { text: '驾驶座上还是杜平。昨天卸货时他倒下去过一次，医生让休息。可线路许可换个人就得重办，没人换得了他。' }
    ],
    effects: {
      addItems: ['personal-water', 'crowbar', 'task-sheet'],
      log: [
        { type: 'fact', text: '任务：到旧物流园确认包装材料货位（空罐、封口膜），供食品厂恢复生产。有护运与运输人员同行。' },
        { type: 'fact', text: '领取借用撬棍一根（编号登记），返程归还；全程无枪械。' }
      ]
    }
  },
  {
