/**
 * chapter1.ts —— 第一章《出墙》叙事数据（纯数据模块，从 story.ts 拆出）
 *
 * 设计基线：doc/02、doc/03、doc/05 正文；节点与验收要求见 doc/24。
 * 本文件只放数据（物品定义 + 节点数组），不含状态机逻辑——引擎部分留在 story.ts。
 * 对话文本为受控改编数据，不把原文直接当作可执行脚本。
 */

import type { ItemDef, NodeDef } from '../story';

// ---------------------------------------------------------------- 物品

export const CH1_ITEMS: Record<string, ItemDef> = {
  gloves: {
...
export const CH1_NODES: NodeDef[] = [
  {
    id: 'C01-00',
    title: '核对任务',
